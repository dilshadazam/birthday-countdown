...
const birthday = new Date(`Oct 8 ${currentYear} 00:00:00`);
...
const age =
  currentDateTime < birthday ? currentYear - 1999 - 1 : currentYear - 1999;
...
function updateCountdown() {
  ...
  const nextBirthday = new Date(`Oct 8 ${currentYear + 1} 00:00:00`);
  ...
  if (April) {
    console.log("Happy Birthday Dilshad Azam");
    message.innerHTML =
      "<br> Guys and Gals, It gives me great pleasure to notify you that today is my birthday.<br>Happy Birthday!! Hope I had a nice Birthday Bash!!";
